...
Live release checkpoint: `v2.1.1`, based on tested demo checkpoint `demo-v2.1.17`.

## LCD Schedule Scope

- LCD Schedule keeps server-backed manual LCD ON/OFF controls.
...
- Operation Manager keeps LCD/e-paper busy guards so LCD photo transfer is rejected while e-paper is busy.
